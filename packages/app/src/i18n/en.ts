...
export const dict = {
  ...
  "command.workspace.codeView": "Toggle code workspace / browser preview",
  "command.workspace.codeView.description": "Switch the side pane between the code workspace and the browser preview",
  "command.workspace.layout.focus": "Switch to Focus layout",
  "command.workspace.layout.focus.description": "Show only the main workspace",
  "command.workspace.layout.dual": "Switch to Dual layout",
  "command.workspace.layout.dual.description": "Show the workspace side by side with the conversation",
  "command.workspace.layout.commandCenter": "Switch to Command Center layout",
  "command.workspace.layout.commandCenter.description": "Show the workspace, conversation, and terminal together",
  "command.workspace.terminal": "Toggle terminal drawer",
  "command.workspace.terminal.description": "Show or hide the bottom terminal drawer",
  ...
  "ui.paneToolbar.mode.focus": "Focus",
  "ui.paneToolbar.mode.dual": "Dual",
  "ui.paneToolbar.mode.commandCenter": "Command Center",
  "ui.paneToolbar.mode.focus.description": "Single pane — full-width chat",
  "ui.paneToolbar.mode.dual.description": "Chat + Code side by side",
  "ui.paneToolbar.mode.commandCenter.description": "File Tree + Chat + Code + Terminal",
  "ui.paneToolbar.toggleFileTree": "File Tree",
  "ui.paneToolbar.toggleTerminal": "Terminal",

  "ui.codeWorkspace.noFiles": "No files open",
  "ui.codeWorkspace.openHint": "Files will appear here when the agent edits them",
  "ui.codeWorkspace.diffSplit": "Split",
  "ui.codeWorkspace.diffUnified": "Unified",
  "ui.codeWorkspace.closeTab": "Close {{name}}",

  "ui.workspace.code": "Code",
  "ui.workspace.browser": "Browser",

  "ui.browserPreview.title": "Browser Preview",
  "ui.browserPreview.back": "Back",
  "ui.browserPreview.forward": "Forward",
  "ui.browserPreview.reload": "Reload",
  "ui.browserPreview.addressLabel": "Address",
  "ui.browserPreview.addressPlaceholder": "https://localhost:4444",
  "ui.browserPreview.viewport.desktop": "Desktop",
  "ui.browserPreview.viewport.tablet": "Tablet",
  "ui.browserPreview.viewport.mobile": "Mobile",
}
