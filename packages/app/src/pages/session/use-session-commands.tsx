...
export type SessionCommandContext = {
  ...
  review?: () => boolean
  fileBrowser?: () => boolean
  setWorkspaceMode?: (mode: LayoutMode) => void
...
export const useSessionCommands = (actions: SessionCommandContext) => {
  ...
  const workspaceCmds = () => [
    viewCommand({
      id: "workspace.codeView",
      title: language.t("command.workspace.codeView"),
      description: language.t("command.workspace.codeView.description"),
      keybind: "mod+b",
      onSelect: () => actions.toggleCodeView?.(),
    }),
    viewCommand({
      id: "workspace.layout.focus",
      title: language.t("command.workspace.layout.focus"),
      description: language.t("command.workspace.layout.focus.description"),
      keybind: "mod+shift+f",
      onSelect: () => actions.setWorkspaceMode?.("focus"),
    }),
    viewCommand({
      id: "workspace.layout.dual",
      title: language.t("command.workspace.layout.dual"),
      description: language.t("command.workspace.layout.dual.description"),
      keybind: "mod+shift+d",
      onSelect: () => actions.setWorkspaceMode?.("dual"),
    }),
    viewCommand({
      id: "workspace.layout.commandCenter",
      title: language.t("command.workspace.layout.commandCenter"),
      description: language.t("command.workspace.layout.commandCenter.description"),
      keybind: "mod+shift+c",
      onSelect: () => actions.setWorkspaceMode?.("command-center"),
    }),
    viewCommand({
      id: "workspace.terminal",
      title: language.t("command.workspace.terminal"),
      description: language.t("command.workspace.terminal.description"),
      keybind: "mod+j",
      onSelect: () => actions.toggleWorkspaceTerminal?.(),
    }),
  ]
